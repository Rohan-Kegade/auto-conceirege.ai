...
export function LandingHeader() {
  ...
  return (
    <header className="sticky top-0 z-[5] flex flex-wrap items-center justify-between gap-5 border-b border-line bg-panel px-6 py-[22px] backdrop-blur-md sm:px-12">
      <Wordmark />
